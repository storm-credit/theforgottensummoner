...
with open(r"C:\Users\Storm Credit\Documents\Obsidian Vault\THE FORGOTTEN SUMMONER\python_copy_log_utf8.txt", "w", encoding="utf-8") as f:
        ...
        for src, dst in dirs:
            ...
            if sd:
                ...
                for item in os.listdir(sd):
                    src_item = os.path.join(sd, item)
                    dst_item = os.path.join(dd, item)
