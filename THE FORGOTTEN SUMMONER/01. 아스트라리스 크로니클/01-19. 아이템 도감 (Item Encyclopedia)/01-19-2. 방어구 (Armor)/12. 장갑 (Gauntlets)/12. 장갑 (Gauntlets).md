---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/12. 장갑 (Gauntlets)/12. 장갑 (Gauntlets)]] (Gauntlets)]
tags: [Item_Encyclopedia, Armor, Hanesis_Protocol]
---

# 12. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/12. 장갑 (Gauntlets)/12. 장갑 (Gauntlets)]] (Gauntlets)

이 문서는 손을 보호하거나 특정 마력의 매개체 역할을 하는 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/12. 장갑 (Gauntlets)/12. 장갑 (Gauntlets)]] (Gauntlets)]**을 집대성한 백과입니다.
