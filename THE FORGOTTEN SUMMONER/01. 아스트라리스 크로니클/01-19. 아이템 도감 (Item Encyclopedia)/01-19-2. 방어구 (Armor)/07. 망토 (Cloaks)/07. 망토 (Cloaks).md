---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/07. 망토 (Cloaks)/07. 망토 (Cloaks)]] (Cloaks)]
tags: [Item_Encyclopedia, Armor, Hanesis_Protocol]
---

# 07. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/07. 망토 (Cloaks)/07. 망토 (Cloaks)]] (Cloaks)

> *"장비의 무게는 곧 생명의 무게이며, 그 안에 담긴 마력은 착용자의 영혼을 투영한다."*

이 문서는 아스트라리스 대륙 내에서 바람과 마력을 두르는 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/07. 망토 (Cloaks)/07. 망토 (Cloaks)]] (Cloaks)]**을 집대성한 공식 분류 백과입니다.
