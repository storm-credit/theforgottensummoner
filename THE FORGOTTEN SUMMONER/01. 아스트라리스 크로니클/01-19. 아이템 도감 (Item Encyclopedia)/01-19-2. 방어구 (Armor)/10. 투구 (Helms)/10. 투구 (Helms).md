---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/10. 투구 (Helms)/10. 투구 (Helms)]] (Helms)]
tags: [Item_Encyclopedia, Armor, Hanesis_Protocol]
---

# 10. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/10. 투구 (Helms)/10. 투구 (Helms)]] (Helms)

이 문서는 전투 중 머리를 보호하는 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/10. 투구 (Helms)/10. 투구 (Helms)]] (Helms)]**을 집대성한 공식 분류 백과입니다.
