---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/11. 얼굴 가리개 (Visors)/11. 얼굴 가리개 (Visors)]] (Visors)]
tags: [Item_Encyclopedia, Armor, Hanesis_Protocol]
---

# 11. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/11. 얼굴 가리개 (Visors)/11. 얼굴 가리개 (Visors)]] (Visors)

이 문서는 가면, 마스크, 고글, 환영 가리개 등 안면을 가리거나 특수 시야를 제공하는 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/11. 얼굴 가리개 (Visors)/11. 얼굴 가리개 (Visors)]] (Visors)]**을 집대성한 공식 백과입니다.
