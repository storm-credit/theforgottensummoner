---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/15. 각반 (Greaves)/15. 각반 (Greaves)]] (Greaves)]
tags: [Item_Encyclopedia, Armor, Hanesis_Protocol]
---

# 15. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/15. 각반 (Greaves)/15. 각반 (Greaves)]] (Greaves)

이 문서는 하체의 방어력을 책임지고 육중한 전술적 보행을 가능하게 하는 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/15. 각반 (Greaves)/15. 각반 (Greaves)]] (Greaves)]** 백과입니다.
