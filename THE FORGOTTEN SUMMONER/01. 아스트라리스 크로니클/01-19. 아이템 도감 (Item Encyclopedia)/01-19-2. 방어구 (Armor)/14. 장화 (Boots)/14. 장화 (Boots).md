---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/14. 장화 (Boots)/14. 장화 (Boots)]] (Boots)]
tags: [Item_Encyclopedia, Armor, Hanesis_Protocol]
---

# 14. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/14. 장화 (Boots)/14. 장화 (Boots)]] (Boots)

이 문서는 지형을 극복하고 이동력을 비약적으로 끌어올리는 특수 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-2. 방어구 (Armor)/14. 장화 (Boots)/14. 장화 (Boots)]] (Boots)]**류 백과입니다.
