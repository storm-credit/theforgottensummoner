---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-4. 유물 (Relics)/04. 소환 매개체 (Summoning Catalysts)/04. 소환 매개체 (Summoning Catalysts)]] (Summoning Catalysts)]
tags: [Item_Encyclopedia, Relic, Hanesis_Protocol]
---

# 04. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-4. 유물 (Relics)/04. 소환 매개체 (Summoning Catalysts)/04. 소환 매개체 (Summoning Catalysts)]] (Summoning Catalysts)

이 문서는 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-4. 유물 (Relics)/04. 소환 매개체 (Summoning Catalysts)/04. 소환 매개체 (Summoning Catalysts)]] (Summoning Catalysts)]**을 집대성한 공식 분류 백과입니다.
