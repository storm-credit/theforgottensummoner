# [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-1. 무기 (Weapons)/02. 장창류 (Polearms & Lances)/빛의 창 아스트라이아 (Astraea)]] (Astraea)
> 시대를 관통하여 전승되는 전설의 무장

| **구분** | **설명** |
| --- | --- |
| **카테고리** | 무기 (장창류) |
| **소유자/보관소** | [[01-20. 직업 & 클래스 (Classes & Jobs)/직업 도감/06. 기사 (Knight)]]단장 발레리온 (A-l-1) |
...
성국 빛 전쟁의 상징(F-b). [[01-15. 인물 백과 (Character Archive)/0. 주인공 일행 (Main Characters)/에반 라크라시스 (Evan)]]이 단기 소환 시 성국 행정부(C-c)의 까다로운 절차적 승인을 거쳐야 할 만큼 위험물로 분류.
