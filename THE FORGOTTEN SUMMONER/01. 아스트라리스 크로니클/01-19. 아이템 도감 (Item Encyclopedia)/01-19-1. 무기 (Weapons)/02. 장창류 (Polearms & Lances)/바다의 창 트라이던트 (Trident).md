# [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-1. 무기 (Weapons)/02. 장창류 (Polearms & Lances)/바다의 창 트라이던트 (Trident)]] (Trident)
...
**창조자**: 칼립소
**역사**: 해양 패권 전쟁(F-b) 승리 후 심해 [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/10. 보석 (Gems)/10. 보석 (Gems)]](G-a-5)과 바다 독수리의 깃털로 장식된 왕권의 상징.
