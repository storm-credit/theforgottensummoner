# [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-1. 무기 (Weapons)/03. 타격류 (Blunts & Axes)/태양의 망치 솔라리스 (Solaris Hammer)]] (Solaris Hammer)
...
언데드를 파쇄할 때마다 과도한 신성력의 섬광이 터진다. 이단 심문 과정에서 망치에 응집된 태양 광석이 소유자의 시력을 단계적으로 태워버려, [[01-20. 직업 & 클래스 (Classes & Jobs)/직업 도감/07. 성기사 (Paladin)]]단장들은 결국 눈을 잃고 영적인 감각에 의존하게 된다.
