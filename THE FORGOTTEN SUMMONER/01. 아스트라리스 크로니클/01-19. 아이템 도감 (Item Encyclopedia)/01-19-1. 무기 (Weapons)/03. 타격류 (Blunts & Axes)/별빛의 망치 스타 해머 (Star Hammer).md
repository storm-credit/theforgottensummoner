...
# [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-1. 무기 (Weapons)/03. 타격류 (Blunts & Axes)/별빛의 망치 스타 해머 (Star Hammer)]] (Star Hammer)
...
별빛 광물에 깃든 마나를 폭발시켜 범위 타격을 가하지만, 마법 연구소의 부작용 통계를 따르면 마력을 공급하는 [[01-20. 직업 & 클래스 (Classes & Jobs)/직업 도감/06. 기사 (Knight)]]의 생명선이 함께 불탄다. 이로 인해 심장 인근에 치명적인 '마나 중독증(마력석 석화)'을 야기한다.
