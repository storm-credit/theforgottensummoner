...
# [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-1. 무기 (Weapons)/08. 방패 (Shields)/드라콘의 빛을 담은 거석 방패 (Light-Bearing Megalith Shield of Dracon)]] (Light-Bearing Megalith Shield of Dracon)

> *"[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-1. 무기 (Weapons)/01. 한손검 (One-handed Swords)/솔라리스 (Solaris)]]의 빛이 닿는 곳, 제국의 심판이 벼려진다."*

## 1. 기본 정보

- **무기명**: [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-1. 무기 (Weapons)/08. 방패 (Shields)/드라콘의 빛을 담은 거석 방패 (Light-Bearing Megalith Shield of Dracon)]] (Light-Bearing Megalith Shield of Dracon)
- **종류**: 방패
- **전용 소유자**: [[티투스 드라콘]]
...
- 소유자 티투스 드라콘의 마나 파장에 맞춰 극한의 빛 마나를 압축, 배출합니다.
