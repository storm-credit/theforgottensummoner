...
# [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-5. 선혈 사냥꾼의 맹세구 및 배지 (Hunter Gear & Badges)/백은 (Silver)]] (Silver)
...
**(재앙의 처형인)** 귀족들도 함부로 대하지 못하는 정예. 이 배지를 내밀면 상업 길드 경매의 VIP 석이 열리며, 타살될 시 국가 단위의 추적이 시작된다.
