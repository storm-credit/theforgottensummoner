---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/06. 브로치 (Brooches)/06. 브로치 (Brooches)]] (Brooches)]
tags: [Item_Encyclopedia, Accessory, Hanesis_Protocol]
---

# 06. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/06. 브로치 (Brooches)/06. 브로치 (Brooches)]] (Brooches)

이 문서는 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/06. 브로치 (Brooches)/06. 브로치 (Brooches)]] (Brooches)]**을 집대성한 공식 분류 백과입니다.
