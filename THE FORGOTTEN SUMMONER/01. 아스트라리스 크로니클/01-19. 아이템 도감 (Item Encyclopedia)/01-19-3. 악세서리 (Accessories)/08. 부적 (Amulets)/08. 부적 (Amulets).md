---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/08. 부적 (Amulets)/08. 부적 (Amulets)]] (Amulets)]
tags: [Item_Encyclopedia, Accessory, Hanesis_Protocol]
---

# 08. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/08. 부적 (Amulets)/08. 부적 (Amulets)]] (Amulets)

이 문서는 저주와 부정을 막거나 반사하는 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/08. 부적 (Amulets)/08. 부적 (Amulets)]] (Amulets)]**을 집대성한 공식 분류 백과입니다.
