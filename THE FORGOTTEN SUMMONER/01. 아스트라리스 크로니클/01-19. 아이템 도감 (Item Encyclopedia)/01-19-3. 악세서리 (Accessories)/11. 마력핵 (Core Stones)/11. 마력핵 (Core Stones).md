---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/11. 마력핵 (Core Stones)/11. 마력핵 (Core Stones)]] (Core Stones)]
tags: [Item_Encyclopedia, Accessory, Hanesis_Protocol]
---

# 11. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/11. 마력핵 (Core Stones)/11. 마력핵 (Core Stones)]] (Core Stones)

이 문서는 마수나 정령의 본질을 결정화시킨 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/11. 마력핵 (Core Stones)/11. 마력핵 (Core Stones)]] (Core Stones)]**을 집대성한 공식 백과입니다.
