---
aliases: [[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/10. 보석 (Gems)/10. 보석 (Gems)]] (Gems)]
tags: [Item_Encyclopedia, Accessory, Hanesis_Protocol]
---

# 10. [[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/10. 보석 (Gems)/10. 보석 (Gems)]] (Gems)

이 문서는 무구에 장착되거나 단독으로 시전되는 정제된 원석류인 **[[[01-19. 아이템 도감 (Item Encyclopedia)/01-19-3. 악세서리 (Accessories)/10. 보석 (Gems)/10. 보석 (Gems)]] (Gems)]**을 집대성한 공식백과입니다.
