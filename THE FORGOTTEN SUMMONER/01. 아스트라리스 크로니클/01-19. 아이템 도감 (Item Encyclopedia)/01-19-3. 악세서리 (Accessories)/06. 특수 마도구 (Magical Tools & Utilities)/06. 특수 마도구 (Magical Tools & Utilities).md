---
aliases: [특수 마도구 (Magical Tools & Utilities)]
tags: [Item_Encyclopedia, Accessory, Hanesis_Protocol]
---

# 06. 특수 마도구 (Magical Tools & Utilities)

> *"장비의 무게는 곧 생명의 무게이며, 그 안에 담긴 마력은 착용자의 영혼을 투영한다."*

이 문서는 아스트라리스 대륙 내에서 유통되거나 전설로 전해지는 **[특수 마도구 (Magical Tools & Utilities)]**을 집대성한 공식 분류 백과입니다.
